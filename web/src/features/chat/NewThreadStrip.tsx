...
export function NewThreadStrip() {
  ...
  return (
    ...
    >
      {ntMenu && <span onClick={closeNtMenu} style={{ position: 'fixed', inset: 0, zIndex: 75 }} />}
        ...
        {ntMenu === 'proj' && (
          ...
          >
            <span style={{ display: 'flex', alignItems: 'baseline', gap: 8, padding: '8px 12px 7px', borderBottom: '1px solid var(--line-divider)' }}>
              <span style={{ ...label(8), color: 'var(--fg-2)' }}>Project</span>
              <span style={{ flex: 1 }} />
            ...
            <span style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 12px', background: 'var(--surface-sunken)' }}>
              <span style={{ ...label(8, '.16em'), color: 'var(--fg-2)', flexShrink: 0 }}>Register</span>
              <input
                value={newPath}
            ...
            <>
              ...
              <span style={{ position: 'relative', display: 'inline-flex', flexShrink: 0, zIndex: 76 }}>
                ...
                {ntMenu === 'br' && (
                  ...
                  >
                    <span style={{ display: 'flex', alignItems: 'baseline', gap: 8, padding: '8px 12px 7px', borderBottom: '1px solid var(--line-divider)' }}>
                      <span style={{ ...label(8), color: 'var(--fg-2)' }}>Branch</span>
                      <span style={{ flex: 1 }} />
                    ...
                    <span style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 12px', background: 'var(--surface-sunken)' }}>
                      <span style={{ ...label(8, '.16em'), color: 'var(--fg-2)', flexShrink: 0 }}>Fork</span>
                      <input
                        value={newBr}
