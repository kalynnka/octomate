    ...
    <div style={{ flex: 1, minHeight: 0, overflowY: 'auto' }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ flex: 1 }} />
          <span style={{ ...label(8, '.18em'), color: 'var(--fg-3)' }}>Control / {page.num}</span>
        </div>
        ...
        >
              ...
              {data.agents.map((a) => (
                <div key={a.name} style={{ padding: '10px 16px', borderBottom: '1px solid var(--line-color)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    <span style={{ ...label(7.5, '.14em'), color: 'var(--fg-2)' }}>{a.state}</span>
                  </div>
                  {a.models.map((m) => (
            ...
            >
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                {data.stats.map((s) => (
                  ...
                  >
                    <div style={{ ...label(7.5, '.16em'), color: 'var(--fg-3)' }}>{s.k}</div>
              ...
              >
                <div style={{ ...label(7.5, '.16em'), color: 'var(--fg-3)', marginBottom: 8 }}>Gateway verbs · 7d</div>
          ...
          {data && mgmtSec === 'settings' && (
            ...
            >
              <div style={{ padding: '4px 16px 2px', ...label(8, '.16em'), color: 'var(--fg-3)' }}>Providers</div>
