...
import { display, ellipsis, fieldLabel, label, mono, serif } from '@/components/text'
      ...
      return (
        ...
        >
          {codeFirst && (
            ...
            >
              <span style={{ ...fieldLabel, color: 'var(--fg-2)' }}>{l.lang ?? 'code'}</span>
              <span style={{ flex: 1 }} />
              <span style={{ ...fieldLabel, color: 'var(--fg-3)' }}>{runLn} ln</span>
            </span>
          )}
          <span
            style={{
          ...
          <span style={{ display: 'inline-flex', border: '1px solid var(--line-divider)' }}>
            <span
              ...
              style={{
                ...
                padding: '3px 8px',
                cursor: 'pointer',
                color: clean ? 'var(--fg-3)' : 'var(--trk-on-fill)',
            ...
            <span
              ...
              style={{
                ...
                padding: '3px 8px',
                cursor: 'pointer',
                color: clean ? 'var(--trk-on-fill)' : 'var(--fg-3)',
