...
1. Do not abuse comments, elegant Elegant, straightfoward code is always better then comments. Add comments only necessary. Avoid drawing split lines with comments.
...
5. Don't abuse `_` prefix to make attribute or methods as `private`. Nothing is real private in python. If there's no specific reason, make everything public.
